        ...
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
            ...
            <form class="form-signin" role="form" method="POST" action="{{ route('password.request') }}">
              ...
              <input id="email" type="hidden" class="form-control" name="email" value="{{ base64_decode(Request::get('code')) }}">
              ...
              <div class="form-label-group">
                <input type="password" id="inputPasswordcc" class="form-control" placeholder="Confirm Password" required="" name="password_confirmation">
                @if ($errors->has('password_confirmation'))
                    <span class="help-block">
                        <strong>{{ $errors->first('password_confirmation') }}</strong>
                    </span>
                @endif
                <label for="inputPasswordcc">Confirm Password</label>
              </div>
